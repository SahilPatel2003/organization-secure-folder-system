...
Given(
  "organization_name:{string}, folder_name:{string}, file_name:{string} download-file",
...
When("tries to download file", async () => {
...
Then(
  "it should return the result: {string} for downloading file",
  async (result) => {
...
Then(
  "it should return the error: {string} for downloading file",
  async (error) => {
